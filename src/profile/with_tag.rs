...
use crate::tags::{
    CurveType, MultiLocalizedUnicodeType, Tag, TextDescriptionType,
...
macro_rules! impl_unambiguous_tag {
    // Takes the tag constant, its data type, and the corresponding Tag enum variant.
...
// --------------------------------------------------------------------------------
// STEP 3: Implement the Traits for Known Tag Signatures
